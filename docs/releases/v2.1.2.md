...
For a new installation, follow [installation](https://github.com/VerbalChainsaw/Lodestar/blob/v2.1.2/docs/installation.md). Existing 2.x
...
backup described in [storage and recovery](https://github.com/VerbalChainsaw/Lodestar/blob/v2.1.2/README.md#storage-and-recovery).
...
ledger update are not one transaction. See [limitations](https://github.com/VerbalChainsaw/Lodestar/blob/v2.1.2/docs/limitations.md) for
